...
```
    ...
    ##    <int> <chr>          <dbl>   <dbl>
    ##  1     0 (Intercept)    1.86   0.139 
    ##  2     0 x              0.792  0.624 
    ##  3     0 (Intercept)    1.68   0.215 
    ##  4     0 x              3.68   0.0182
    ##  5     0 (Intercept)    2.23   0.144 
    ##  6     0 x             -1.47   0.385 
    ##  7     0 (Intercept)    1.02   0.329 
    ##  8     0 x             -0.610  0.539 
    ##  9     0 (Intercept)    3.54   0.0447
    ## 10     0 x             -0.161  0.943 
...
| beta1 | term        |    estimate |   p.value |
| ----: | :---------- | ----------: | --------: |
|     0 | (Intercept) |   1.8623179 | 0.1388877 |
|     0 | x           |   0.7923513 | 0.6236058 |
|     0 | (Intercept) |   1.6800233 | 0.2152550 |
|     0 | x           |   3.6775701 | 0.0181979 |
|     0 | (Intercept) |   2.2304150 | 0.1441838 |
|     0 | x           | \-1.4737827 | 0.3849481 |
